...
from Silhouetto import SilhouettoVersion
...
class InnoScript:
    ...
    def create(self, pathname="dist\\Silhouetto.iss"):
...
class build_installer(py2exe):
    ...
    def run(self):
        ...
        script = InnoScript("Silhouetto",
                            "DiploSoft",
                            lib_dir,
                            dist_dir,
                            self.windows_exe_files,
                            self.lib_files,
                            version = SilhouettoVersion)
...
data_files = [ ('icon',['Silhouetto.ico']),     
                   #('',['anna-f.tps', 'anna-s.tps' ]),
              ]
...
if go_build:
  setup(
      ...
      zipfile = zipfile,
      windows = [{'script':'Silhouetto.py','icon_resources':[(1,'Silhouetto.ico')]}],
