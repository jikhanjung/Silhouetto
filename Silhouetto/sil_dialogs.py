...
CONTROL_ID['ID_BNC_OK_BUTTON'] = 1001
CONTROL_ID['ID_BNC_CANCEL_BUTTON'] = 1002
...
class BrightnessAndContrastDialog(wx.Dialog):
    def __init__(self, parent, wid):
        ...
        self.okButton = wx.Button(panel, CONTROL_ID['ID_BNC_OK_BUTTON'], 'OK')
        self.cancelButton = wx.Button(panel, CONTROL_ID['ID_BNC_CANCEL_BUTTON'], 'Cancel')
        self.Bind(wx.EVT_BUTTON, self.OnOk, id=CONTROL_ID['ID_BNC_OK_BUTTON'])
        self.Bind(wx.EVT_BUTTON, self.OnCancel, id=CONTROL_ID['ID_BNC_CANCEL_BUTTON'])
    ...
    def OnSlide(self, evt):
        ...
        adjusted_thumb = self.AdjustBrightnessAndContrast(thumbnail, ( bright / 200.0 ) + 1.0,
                                                          ( contrast / 200.0 ) + 1.0)
...
CONTROL_ID['ID_LOAD_IMAGE_BUTTON'] = 1001
CONTROL_ID['ID_ADD_OBJECT_BUTTON'] = 1002
CONTROL_ID['ID_FFT_BUTTON'] = 1009
CONTROL_ID['ID_BNC_BUTTON'] = 1003
CONTROL_ID['ID_CALIBRATION_BUTTON'] = 1004
CONTROL_ID['ID_BNW_BUTTON'] = 1005
CONTROL_ID['ID_SELECT_BUTTON'] = 1006
CONTROL_ID['ID_UNDO_BUTTON'] = 1007
CONTROL_ID['ID_REDO_BUTTON'] = 1008
CONTROL_ID['ID_DILATION_BUTTON'] = 1009
CONTROL_ID['ID_EROSION_BUTTON'] = 1010
CONTROL_ID['ID_GET_SEGMENTS_BUTTON'] = 1011
CONTROL_ID['ID_REMOVE_NOISE_BUTTON'] = 1012

CONTROL_ID['ID_OK_BUTTON'] = 1021
CONTROL_ID['ID_CANCEL_BUTTON'] = 1022
...
class SilhouettoOutlineDialog(wx.Dialog):
    def __init__(self, parent, wid):
        ...
        loadImageButton = wx.Button(panel, CONTROL_ID['ID_LOAD_IMAGE_BUTTON'], 'Load')
        self.Bind(wx.EVT_BUTTON, self.LoadImage, id=CONTROL_ID['ID_LOAD_IMAGE_BUTTON'])
        ...
        ''' Calibration'''
        calibrationButton = wx.Button(panel, CONTROL_ID['ID_CALIBRATION_BUTTON'], 'Calib.')
        self.Bind(wx.EVT_BUTTON, self.Calibrate, id=CONTROL_ID['ID_CALIBRATION_BUTTON'])
        sizer1.Add(calibrationButton)

        ''' Brightness and Contrast'''
        BrightnessAndContrastButton = wx.Button(panel, CONTROL_ID['ID_BNC_BUTTON'], 'Bright/Cont')
        self.Bind(wx.EVT_BUTTON, self.OnBrightnessAndContrast, id=CONTROL_ID['ID_BNC_BUTTON'])
        sizer1.Add(BrightnessAndContrastButton)

        ''' Black and white'''
        BlackAndWhiteButton = wx.Button(panel, CONTROL_ID['ID_BNW_BUTTON'], 'B&W')
        self.Bind(wx.EVT_BUTTON, self.OnBlackAndWhite, id=CONTROL_ID['ID_BNW_BUTTON'])
        sizer1.Add(BlackAndWhiteButton)

        ''' Select region '''
        SelectRegionButton = wx.Button(panel, CONTROL_ID['ID_SELECT_BUTTON'], 'Select')
        self.Bind(wx.EVT_BUTTON, self.OnSelectRegion, id=CONTROL_ID['ID_SELECT_BUTTON'])
        sizer1.Add(SelectRegionButton)

        ''' Undo Image Operation'''
        undoButton = wx.Button(panel, CONTROL_ID['ID_UNDO_BUTTON'], 'Undo')
        self.Bind(wx.EVT_BUTTON, self.Undo, id=CONTROL_ID['ID_UNDO_BUTTON'])
        sizer1.Add(undoButton)

        ''' Redo Image Operation'''
        redoButton = wx.Button(panel, CONTROL_ID['ID_REDO_BUTTON'], 'Redo')
        self.Bind(wx.EVT_BUTTON, self.Redo, id=CONTROL_ID['ID_REDO_BUTTON'])
        sizer1.Add(redoButton)

        ''' Dilation '''
        dilationButton = wx.Button(panel, CONTROL_ID['ID_DILATION_BUTTON'], 'Dilation')
        self.Bind(wx.EVT_BUTTON, self.OnDilation, id=CONTROL_ID['ID_DILATION_BUTTON'])
        sizer2.Add(dilationButton)

        ''' Erosion '''
        erosionButton = wx.Button(panel, CONTROL_ID['ID_EROSION_BUTTON'], 'Erosion')
        self.Bind(wx.EVT_BUTTON, self.OnErosion, id=CONTROL_ID['ID_EROSION_BUTTON'])
        sizer2.Add(erosionButton)

        ''' GetSegments'''
        getSegmentsButton = wx.Button(panel, CONTROL_ID['ID_GET_SEGMENTS_BUTTON'], 'Get Segments')
        self.Bind(wx.EVT_BUTTON, self.OnGetSegments, id=CONTROL_ID['ID_GET_SEGMENTS_BUTTON'])
        sizer2.Add(getSegmentsButton)

        ''' RemoveNoise'''
        removeNoiseButton = wx.Button(panel, CONTROL_ID['ID_REMOVE_NOISE_BUTTON'], 'Remove Noise')
        self.Bind(wx.EVT_BUTTON, self.OnRemoveNoise, id=CONTROL_ID['ID_REMOVE_NOISE_BUTTON'])
        sizer2.Add(removeNoiseButton)

        sizer3 = wx.BoxSizer(wx.HORIZONTAL)

        ''' OK '''
        okButton = wx.Button(panel, CONTROL_ID['ID_OK_BUTTON'], 'OK')
        self.Bind(wx.EVT_BUTTON, self.OnOk, id=CONTROL_ID['ID_OK_BUTTON'])
        sizer3.Add(okButton)
        ''' Cancel '''
        cancelButton = wx.Button(panel, CONTROL_ID['ID_CANCEL_BUTTON'], 'CANCEL')
        self.Bind(wx.EVT_BUTTON, self.OnCancel, id=CONTROL_ID['ID_CANCEL_BUTTON'])
    ...
    def OnSelectRegion(self, evt):
        self.TwoDViewer.SetMode(CONTROL_ID['ID_SELECT_REGION_MODE'])
        return
    ...
    def Calibrate(self, evt):
        self.TwoDViewer.SetMode(CONTROL_ID['ID_CALIBRATION_MODE'])
        return
...
class SilhouettoMainDialog(wx.Frame):
    def __init__(self, parent, wid):
        ...
        addObjectButton = wx.Button(panel, CONTROL_ID['ID_ADD_OBJECT_BUTTON'], 'Add')
        self.Bind(wx.EVT_BUTTON, self.AddObject, id=CONTROL_ID['ID_ADD_OBJECT_BUTTON'])

        fftButton = wx.Button(panel, CONTROL_ID['ID_FFT_BUTTON'], 'FFT')
        self.Bind(wx.EVT_BUTTON, self.OnFFT, id=CONTROL_ID['ID_FFT_BUTTON'])
